...
Pre-built structures are in the [output](https://github.com/mariomarroquim/hla-modeller/tree/main/output) folder. To regenerate models after a new IPD-IMGT/HLA release, run `ruby run.rb`. To view a model, download its PDB file from output and open it in a viewer such as [Mol*](https://molstar.org/viewer).
